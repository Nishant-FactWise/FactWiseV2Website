...
export default function ReqToPoFlow() {
    ...
    return (
        <>
            ...
            >
                {/* PANEL 0 */}
                <div className="rtpf-panel" style={{ position: 'absolute', inset: 0, background: 'white', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
                ...
                {/* PANEL 1 */}
                <div className="rtpf-panel rtpf-panel-slide" style={{
                ...
                {/* PANEL 2 */}
                <div className="rtpf-panel rtpf-panel-slide" style={{ position: 'absolute', inset: 0, background: 'white', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
                    <div style={{ width: '100%', maxWidth: 1360, margin: '0 auto', padding: '0 24px' }}>
